const ja: Record<string, string> = {
  ...
  // Derived recipes (派生設問)
  "section.derived": "派生設問",
  "derived.empty": "派生設問はまだありません",
  "derived.add": "追加",
  "derived.edit": "編集",
  "derived.delete": "削除",
  "derived.kind.combineSA": "SA掛け合わせ",
  "derived.kind.binNA": "NAビニング",
  "derived.dialog.title": "派生設問を追加",
  "derived.dialog.combineSA.desc": "複数のSA設問を直積で組み合わせて新しいSA軸を作る",
  "derived.dialog.binNA.desc": "数値設問を範囲でビニングしてSA軸に変換する",
  "derived.cancel": "キャンセル",
  "derived.save": "保存",
  "derived.saving": "保存中...",
  "derived.field.code": "コード",
  "derived.field.label": "設問名",
  "derived.binNA.label.suffix": "（ビニング）",
  "derived.combineSA.sources": "ソース設問（SA、2つ以上）",
  "derived.combineSA.separator": "区切り文字",
  "derived.combineSA.preview.count": "生成される項目数: {count}",
  "derived.combineSA.preview.sample": "サンプル",
  "derived.binNA.source": "ソース設問（NA）",
  "derived.binNA.bins": "ビン定義",
  "derived.binNA.bin.code": "コード",
  "derived.binNA.bin.label": "ラベル",
  "derived.binNA.bin.min": "min",
  "derived.binNA.bin.max": "max",
  "derived.binNA.bin.minHint": "空欄=−∞",
  "derived.binNA.bin.maxHint": "空欄=+∞",
  "derived.binNA.bin.add": "行を追加",
  "derived.binNA.preset.label": "プリセット",
  "derived.binNA.preset.fill10": "10刻みで埋める",
  "derived.binNA.preset.fill5": "5刻みで埋める",
  "derived.binNA.preset.quartile": "四分位で埋める",
  "derived.binNA.preset.confirm": "現在のビン定義を上書きします。よろしいですか？",
  "derived.binNA.coverage.uncoveredOf": "{count} / {total} 件が未分類",
  "derived.binNA.coverage.range": "値の範囲: {min} 〜 {max}",
  "derived.binNA.coverage.uncovered": "{count} 件がどのビンにも該当しません",
  "derived.binNA.coverage.full": "全 {total} 件をカバー",
  "derived.error.required": "必須項目が未入力です",
  "derived.error.title": "保存に失敗しました",
  "derived.popover.add": "+ 派生設問を追加",
  "derived.delete.confirm": '派生設問 "{code}" を削除しますか？',
};
